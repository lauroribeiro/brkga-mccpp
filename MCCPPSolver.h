...
public:
	...
	MCCPPSolver(const Graph& instance, const std::vector< double >& chromosome);
	virtual ~MCCPPSolver();

	double getChromaticPartitionCost();		        // Returns the chromatic partition cost
	std::vector<int>& getChromaticPartition();	// Returns the chromatic partition
